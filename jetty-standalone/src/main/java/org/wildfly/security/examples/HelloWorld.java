...
public class HelloWorld {
    ...
    private static ElytronAuthenticator createElytronAuthenticator() throws Exception {
        ...
        httpServerMechanismFactory = new FilterServerMechanismFactory(providerFactory, true, "BASIC");
